...
void CreateVBO(void)
{
    ...
    GLfloat Vertices[] = {
        -0.4f, -0.4f, 0.0f, 1.0f, //STANGA JOS  F1
        -0.4f,  0.4f, 0.0f, 1.0f, //STANGA SUS  F1
         0.4f,  0.3f, 0.0f, 1.0f, //DREAPTA SUS F1
         0.4f, -0.5f, 0.0f, 1.0f, //DREAPTA JOS F1
        -0.4f, -0.4f, 0.0f, 1.0f, //STANGA JOS  F1
         0.4f, -0.5f, 0.0f, 1.0f, //STANGA JOS F2
         0.4f,  0.3f, 0.0f, 1.0f, //STANGA SUS F2
         0.8f,  0.6f, 0.0f, 1.0f, //DREAPTA SUS F2
         0.8f, -0.2f, 0.0f, 1.0f, //DREAPTA JOS F2
         0.4f, -0.5f, 0.0f, 1.0f, //STANGA JOS F2
        -0.4f,  0.4f, 0.0f, 1.0f, //STANGA JOS F3
         0.0f,  0.7f, 0.0f, 1.0f, //STANGA SUS F3
         0.8f,  0.6f, 0.0f, 1.0f, //DREAPTA SUS F3
         0.4f,  0.3f, 0.0f, 1.0f, //DREAPTA JOS F3
        -0.4f,  0.4f, 0.0f, 1.0f, //STANGA JOS F3
...
void RenderFunction(void)
{
    ...
    glDrawArrays(GL_TRIANGLES, 0, 3);  //TRIANGLES POINTS LINES LINE_STRIP    
...
int main(int argc, char* argv[])
{
    ...
    glutCreateWindow("Cub RGB - OpenGL <<nou>>");   //	 Creeaza fereastra de vizualizare, indicand numele acesteia;
