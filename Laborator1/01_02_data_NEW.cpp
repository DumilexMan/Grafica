...
void CreateVBO(void)
{
    ...
    GLfloat Vertices[] = {
        ...
        -0.25f,-0.2f, 0.0f, 1.0f,//
        -0.3f, -0.3f, 0.0f, 1.0f,//O
        -0.5f, -0.3f, 0.0f, 1.0f,//
        -0.55f,-0.2f, 0.0f, 1.0f,//
        -0.55f,-0.0f, 0.0f, 1.0f,
        -0.5f,  0.1f, 0.0f, 1.0f,

         0.0f,  0.2f, 0.0f, 1.0f,          ///1
         0.3f,  0.2f, 0.0f, 1.0f,          ///2
         0.2f,  0.1f, 0.0f, 1.0f,           //2
         0.0f,  0.1f, 0.0f, 1.0f,           //1
         0.0f,  0.1f, 0.0f, 1.0f,           //9
        -0.05f,-0.0f, 0.0f, 1.0f,           //8
        -0.05f,-0.2f, 0.0f, 1.0f,//         //7
         0.0f, -0.3f, 0.0f, 1.0f,//         //6
         0.2f, -0.3f, 0.0f, 1.0f,//C        //5
         0.3f, -0.4f, 0.0f, 1.0f,//C       ///5
         0.0f, -0.4f, 0.0f, 1.0f,//        ///6
        -0.1f, -0.2f, 0.0f, 1.0f,//        ///7
        -0.1f,  0.0f, 0.0f, 1.0f,          ///8
         0.0f,  0.2f, 0.0f, 1.0f,          ///1
        ...
        -0.65f,-0.8f, 0.0f, 1.0f,
        -0.45f,-0.8f, 0.0f, 1.0f,

        -0.2f, -0.5f, 0.0f, 1.0f,
        -0.1f, -0.5f, 0.0f, 1.0f,
        -0.05f,-0.6f, 0.0f, 1.0f,
        -0.05f,-0.7f, 0.0f, 1.0f,
        -0.1f, -0.8f, 0.0f, 1.0f,//0
        -0.2f, -0.8f, 0.0f, 1.0f,
        -0.25f,-0.7f, 0.0f, 1.0f,
        -0.25f,-0.6f, 0.0f, 1.0f,
        -0.2f, -0.5f, 0.0f, 1.0f,
        
         0.15f,-0.6f, 0.0f, 1.0f,
         0.2f, -0.5f, 0.0f, 1.0f,
         0.3f, -0.5f, 0.0f, 1.0f,//2
         0.35f,-0.6f, 0.0f, 1.0f,
         0.15f,-0.8f, 0.0f, 1.0f,
         0.35f,-0.8f, 0.0f, 1.0f,

         0.55f,-0.5f, 0.0f, 1.0f,
         0.75f,-0.5f, 0.0f, 1.0f,
         0.75f,-0.65f,0.0f, 1.0f,
         0.60f,-0.65f,0.0f, 1.0f,//3
         0.75f,-0.65f,0.0f, 1.0f,
...
{
    glClearColor(0.3f, 0.1f, 0.42f, 0.0f);   //  Culoarea de fond a ecranului;
...
void RenderFunction(void)
{
    ...
    glDrawArrays(GL_LINE_STRIP, 0, 2);  //TRIANGLES POINTS LINES LINE_STRIP    
    glDrawArrays(GL_LINE_STRIP, 1, 2);
    glDrawArrays(GL_LINE_STRIP, 2, 2);
    glDrawArrays(GL_LINE_STRIP, 3, 2);
    glDrawArrays(GL_LINE_STRIP, 4, 2);  //5
    glDrawArrays(GL_LINE_STRIP, 5, 2);
    ...
    glDrawArrays(GL_LINE_STRIP, 11, 2);
    glDrawArrays(GL_LINE_STRIP, 12, 2); //O EXTERIOR
    glDrawArrays(GL_LINE_STRIP, 13, 2);
    glDrawArrays(GL_LINE_STRIP, 14, 2);
    glDrawArrays(GL_LINE_STRIP, 15, 2);
    glDrawArrays(GL_LINE_STRIP, 16, 2);

    glDrawArrays(GL_LINE_STRIP, 18, 2);
    glDrawArrays(GL_LINE_STRIP, 19, 2);
    glDrawArrays(GL_LINE_STRIP, 20, 2);
    glDrawArrays(GL_LINE_STRIP, 21, 2); //O INTERIOR
    glDrawArrays(GL_LINE_STRIP, 22, 2);
    ...
    glDrawArrays(GL_LINE_STRIP, 39, 2);//}EXTERIOR

    glDrawArrays(GL_LINE_STRIP, 41, 2);
    glDrawArrays(GL_LINE_STRIP, 42, 2);
    glDrawArrays(GL_LINE_STRIP, 43, 2);
    glDrawArrays(GL_LINE_STRIP, 44, 2);
    glDrawArrays(GL_LINE_STRIP, 45, 2);
    glDrawArrays(GL_LINE_STRIP, 46, 2);
    glDrawArrays(GL_LINE_STRIP, 47, 2);
    glDrawArrays(GL_LINE_STRIP, 47, 2);
    glDrawArrays(GL_LINE_STRIP, 48, 2);

    glDrawArrays(GL_LINE_STRIP, 50, 2);
    glDrawArrays(GL_LINE_STRIP, 51, 2);
    glDrawArrays(GL_LINE_STRIP, 52, 2);
    glDrawArrays(GL_LINE_STRIP, 53, 2);
    glDrawArrays(GL_LINE_STRIP, 54, 2);

    glDrawArrays(GL_LINE_STRIP, 56, 2);
    glDrawArrays(GL_LINE_STRIP, 57, 2);
    glDrawArrays(GL_LINE_STRIP, 58, 2);
    glDrawArrays(GL_LINE_STRIP, 59, 2);
    glDrawArrays(GL_LINE_STRIP, 60, 2);
    glDrawArrays(GL_LINE_STRIP, 61, 2);
    glDrawArrays(GL_LINE_STRIP, 62, 2);
    glDrawArrays(GL_LINE_STRIP, 63, 2);

    glDrawArrays(GL_LINE_STRIP, 65, 2);
    glDrawArrays(GL_LINE_STRIP, 66, 2);
    glDrawArrays(GL_LINE_STRIP, 67, 2);
    glDrawArrays(GL_LINE_STRIP, 68, 2);
    glDrawArrays(GL_LINE_STRIP, 69, 2);

    glDrawArrays(GL_LINE_STRIP, 71, 2);
    glDrawArrays(GL_LINE_STRIP, 72, 2);
    glDrawArrays(GL_LINE_STRIP, 73, 2);
    glDrawArrays(GL_LINE_STRIP, 74, 2);
    glDrawArrays(GL_LINE_STRIP, 75, 2);
    glDrawArrays(GL_LINE_STRIP, 76, 2);
...
int main(int argc, char* argv[])
{
    ...
    glutInitWindowSize(750, 750);                            //  Dimensiunea ferestrei;
    glutCreateWindow("Data scrisa cu segmente de dreapta - OpenGL <<nou>>");   //	 Creeaza fereastra de vizualizare, indicand numele acesteia;
